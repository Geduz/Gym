...
export function useEntrenadores() {
    const [trainers, setTrainers] = useState<Entrenadores[]>([])
    ...
    const fetchEntrenadores = useCallback(async () => {
        ...
        try {
            ...
            if (!res.ok) throw new Error("Error al obtener los entrenadores")
            ...
            if (res.ok) {
                ...
                toast({
                    title: "Error",
                    description: "No se pudieron obtener los entrenadores",
                    duration: 3000,
                })
            }
        } catch (error) {
            ...
            toast({
                title: "Error",
                description: "Hubo un problema al cargar los entrenadores",
                duration: 3000,
            })
        } finally {
            setLoading(false)
    ...
    return { trainers, loading, error, fetchEntrenadores, createEntrenador, deleteEntrenador }
}
